...
// src/LL/BarterBundle/Entity/Document.php
...
/**
 * @ORM\Entity(repositoryClass="LL\BarterBundle\Entity\DocumentRepository")
...
class Document {
    ...
    public function getUploadDir() {
        // On retourne le chemin relatif vers le document pour un navigateur
        return 'uploads/img';
    }

    protected function getUploadRootDir() {
        // On retourne le chemin absolu vers le document pour notre code PHP
